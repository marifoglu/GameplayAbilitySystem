...
void UAuraAttributeSet::OnRep_LightningResistance(const FGameplayAttributeData& OldOnRep_LightningResistance) const
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UAuraAttributeSet, LightningResistance, OldOnRep_LightningResistance);
}
