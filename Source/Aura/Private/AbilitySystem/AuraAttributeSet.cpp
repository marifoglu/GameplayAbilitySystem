...
void UAuraAttributeSet::PostGameplayEffectExecute(const FGameplayEffectModCallbackData& Data)
{
	...
	if (Data.EvaluatedData.Attribute == GetInComingXPAttribute())
	{
		...
		// Source Character is the Owner! since GA_ListenForEvents applies GE_EventBasedEffect, adding to IncomeXP
		if (Props.SourceCharacter->Implements<UPlayerInterface>() && Props.SourceCharacter->Implements<UCombatInterface>())
		{
			...
			if (NewLevelUps > 0)
			{
				...
				const int32 AttributePointsReward = IPlayerInterface::Execute_GetAttributePointsReward(Props.SourceCharacter, NewLevelUps);
				
				// GetSpellPointReward
				const int32 SpellPointsReward = IPlayerInterface::Execute_GetSpellPointsReward(Props.SourceCharacter, NewLevelUps);
				...
				// Fill up with Health and Mana
				// SetHealth(GetMaxHealth()); // old
				// SetMana(GetMaxMana()); // old
